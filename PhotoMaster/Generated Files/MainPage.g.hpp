...
void ::PhotoMaster::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::PhotoMaster::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
